...
/**
 * Allows the aws-cpp-sdk to use Unreal's FMemory system as a memory allocator.
 * This is crucial to avoid memory crashes caused by allocator mismatch on platforms like iOS
 * @note This requires the aws-cpp-sdk to be built using USE_AWS_MEMORY_MANAGEMENT
 */
